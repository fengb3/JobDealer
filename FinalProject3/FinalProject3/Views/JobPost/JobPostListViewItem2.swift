...
struct JobPostListViewItem2: View {
    ...
    var body: some View {
        Button(action: {isPresented = true})
        {
            HStack
            {
                ...
                {
                    JobPostEditView(jobPost: data.jobPost)
                }
    }
}

struct JobPostListViewItem2_Previews: PreviewProvider {
    static var previews: some View {
        ...
        return JobPostListViewItem2(data: data)
    }
}
