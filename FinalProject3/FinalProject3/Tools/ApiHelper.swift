...
struct ApiRequest
{
	...
	func headers(_ headers: @escaping () -> [String: String]) -> ApiRequest
	{
		var request = self
		request.headers = headers()
		return request
	...
	func send()
	{
		...
		sendApiRequest(url, method, body, headers, onError, onBadResponse, onSuccess)
	}
}

func sendApiRequest(_ url: String, _ method: HTTPMethod, _ body: Data?, _ headers: [String: String],
